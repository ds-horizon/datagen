...
| Flag | Description | Short | Example |
|------|-------------|-------|---------|
| `--config` | Path to configuration JSON file | `-c` | `-c config.json` |
| `--output` | Output directory for logs/artifacts | `-o` | `-o ./logs` |
