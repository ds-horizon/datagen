...
When you run `datagenc gen user.dg`, it creates records like: 
...
- **[Advanced Concepts](/datagen/concepts/advanced-concepts)** - Learn about the `iter` variable, cross-model references, and optional sections (`metadata`, `misc`, `calls`)
