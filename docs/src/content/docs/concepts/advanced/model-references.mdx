...
model Product {
  fields {
    id() int
    price(min float64, max float64) float32  // Parameterized field
...
```shell
Order{id:1 base_amount:377.41 tax_amount:30.19 total_amount:407.60}
Order{id:2 base_amount:441.55 tax_amount:35.32 total_amount:476.87}
Order{id:3 base_amount:303.28 tax_amount:24.26 total_amount:327.54}
Order{id:4 base_amount:153.99 tax_amount:12.32 total_amount:166.31}
Order{id:5 base_amount:218.52 tax_amount:17.48 total_amount:236.00}
```
...
Customer{id:4 tier:premium}
Customer{id:5 tier:standard}
Order{id:1 customer_id:208 discount:2.0 total:382.70}
Order{id:2 customer_id:208 discount:2.0 total:366.23}
Order{id:3 customer_id:798 discount:2.0 total:213.29}
Order{id:4 customer_id:4 discount:20.0 total:169.98}
Order{id:5 customer_id:397 discount:2.0 total:311.95}
```
