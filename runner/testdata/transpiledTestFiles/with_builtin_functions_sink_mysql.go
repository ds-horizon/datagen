...
func Sink_mysql___datagen_with_builtin_functions_data(modelName string, records []*__datagen_with_builtin_functions, config *MySQLConfig) error {
...
func Clear_mysql___datagen_with_builtin_functions_data(modelName string, config *MySQLConfig) error {
