...
func Sink_mysql___datagen_minimal_data(modelName string, records []*__datagen_minimal, config *__dgi_MySQLConfig) error {
...
func Clear_mysql___datagen_minimal_data(modelName string, config *__dgi_MySQLConfig) error {
