...
func Sink_mysql___datagen_with_maps_data(modelName string, records []*__datagen_with_maps, config *MySQLConfig) error {
...
func Clear_mysql___datagen_with_maps_data(modelName string, config *MySQLConfig) error {
