...
func Sink_mysql___datagen_nested_data(modelName string, records []*__datagen_nested, config *MySQLConfig) error {
...
func Clear_mysql___datagen_nested_data(modelName string, config *MySQLConfig) error {
