...
func Sink_mysql___datagen_simple_data(modelName string, records []*__datagen_simple, config *MySQLConfig) error {
...
func Clear_mysql___datagen_simple_data(modelName string, config *MySQLConfig) error {
