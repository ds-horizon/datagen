...
func Sink_mysql___datagen_with_metadata_data(modelName string, records []*__datagen_with_metadata, config *MySQLConfig) error {
...
func Clear_mysql___datagen_with_metadata_data(modelName string, config *MySQLConfig) error {
